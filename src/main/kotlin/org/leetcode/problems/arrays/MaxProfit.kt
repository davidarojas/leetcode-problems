 ...
 *
 * 1. The brute force solution would have been to go through the array and check each number against each other (O(n^2))
 *
 * 2. Again, the important question here is: how can I track the values I NEED as I loop through? Here, I need to remember
 ...
 *
 * 3. This solution works in O(n) time complexity, and O(1) space complexity, due to the variables we are using.
 *
